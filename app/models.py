...
class Participant(db.Model):
    ...
    fcd = db.Column(db.Integer, default=0)
    usd = db.Column(db.Integer, default=0)
    sar = db.Column(db.Integer, default=0)
    rub = db.Column(db.Integer, default=0)
    yen = db.Column(db.Integer, default=0)
